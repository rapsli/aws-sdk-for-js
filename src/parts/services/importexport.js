...
AmazonImportExport.prototype = {
  ...
  /**
	 ...
	 *
	 * @param {String} [job_id] A unique identifier which refers to a particular job.
  ...
  /**
	 ...
	 *
	 * @param {String} [job_type] Specifies whether the job to initiate is an import or export job. [Allowed values: <code>Import</code>, <code>Export</code>]
	 * @param {String} [manifest] The UTF-8 encoded text of the manifest file.
	 * @param {Boolean} [validate_only] Validate the manifest and parameter values in the request but do not actually create a job.
	 * @param {Object} [opt] An associative array of parameters that can have the following keys: <ul>
